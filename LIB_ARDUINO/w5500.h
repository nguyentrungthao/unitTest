...
public:
  ...
  // __GP_REGISTER16(RTR,    0x0017);    // Timeout address <== this is true for W5100 not W5500
  // __GP_REGISTER8(RCR, 0x0019);    // Retry count <== this is true for W5100 not W5500
  ...
  __GP_REGISTER8(RCR, 0x001B);   // Retry count (W5500)
  // end new update
